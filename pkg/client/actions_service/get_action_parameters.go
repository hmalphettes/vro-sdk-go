...
// WithActionName adds the actionName to the get action params
func (o *GetActionParams) WithActionName(actionName string) *GetActionParams {
	o.SetActionName(actionName)
	return o
}

// SetActionName adds the actionName to the get action params
func (o *GetActionParams) SetActionName(actionName string) {
	o.ActionName = actionName
}

// WithCategoryName adds the categoryName to the get action params
func (o *GetActionParams) WithCategoryName(categoryName string) *GetActionParams {
	o.SetCategoryName(categoryName)
	return o
}

// SetCategoryName adds the categoryName to the get action params
func (o *GetActionParams) SetCategoryName(categoryName string) {
