...
// WithXVROChangesetSha adds the xVROChangesetSha to the update resource params
func (o *UpdateResourceParams) WithXVROChangesetSha(xVROChangesetSha *string) *UpdateResourceParams {
	o.SetXVROChangesetSha(xVROChangesetSha)
	return o
}

// SetXVROChangesetSha adds the xVROChangesetSha to the update resource params
func (o *UpdateResourceParams) SetXVROChangesetSha(xVROChangesetSha *string) {
	o.XVROChangesetSha = xVROChangesetSha
}

// WithFile adds the file to the update resource params
func (o *UpdateResourceParams) WithFile(file runtime.NamedReadCloser) *UpdateResourceParams {
	o.SetFile(file)
	return o
}

// SetFile adds the file to the update resource params
func (o *UpdateResourceParams) SetFile(file runtime.NamedReadCloser) {
	o.File = file
}
