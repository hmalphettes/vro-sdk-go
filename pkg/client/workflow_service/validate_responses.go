...
func (o *ValidateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /workflows/validate/schema] validate", response, response.Code())
	}
}
...
func (o *ValidateOK) Error() string {
	return fmt.Sprintf("[PUT /workflows/validate/schema][%d] validateOK  %+v", 200, o.Payload)
}
...
func (o *ValidateOK) GetPayload() *models.ValidationMessages {
	return o.Payload
}
