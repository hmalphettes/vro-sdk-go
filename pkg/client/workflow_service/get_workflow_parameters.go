...
// WithID adds the id to the get workflow params
func (o *GetWorkflowParams) WithID(id string) *GetWorkflowParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get workflow params
func (o *GetWorkflowParams) SetID(id string) {
	o.ID = id
}
