...
// WithID adds the id to the delete policy template params
func (o *DeletePolicyTemplateParams) WithID(id string) *DeletePolicyTemplateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete policy template params
func (o *DeletePolicyTemplateParams) SetID(id string) {
	o.ID = id
}
