...
func (o *GetPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /policies/{id}] getPolicy", response, response.Code())
	}
}
...
func (o *GetPolicyUnauthorized) Error() string {
	return fmt.Sprintf("[GET /policies/{id}][%d] getPolicyUnauthorized ", 401)
}
...
func (o *GetPolicyNotFound) Error() string {
	return fmt.Sprintf("[GET /policies/{id}][%d] getPolicyNotFound ", 404)
}
