...
//
// swagger:model user-group
type UserGroup struct {

	// cn
	Cn string `json:"cn,omitempty" xml:"cn,attr,omitempty"`

	// display name
	DisplayName string `json:"display-name,omitempty" xml:"display-name,attr,omitempty"`

	// dn
	Dn string `json:"dn,omitempty" xml:"dn,attr,omitempty"`
	...
	// info
	Info string `json:"info,omitempty" xml:"info,attr,omitempty"`

	// relations
	Relations *Relations `json:"relations,omitempty"`

	// sid
	Sid string `json:"sid,omitempty" xml:"sid,attr,omitempty"`
}
...
func (m *UserGroup) validateRelations(formats strfmt.Registry) error {
...
func (m *UserGroup) contextValidateRelations(ctx context.Context, formats strfmt.Registry) error {
