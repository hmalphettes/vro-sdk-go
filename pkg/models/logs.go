...
func (m *Logs) validateLogs(formats strfmt.Registry) error {
...
func (m *Logs) contextValidateLogs(ctx context.Context, formats strfmt.Registry) error {
