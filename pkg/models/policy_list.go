...
func (m *PolicyList) validateRelations(formats strfmt.Registry) error {
...
func (m *PolicyList) contextValidateRelations(ctx context.Context, formats strfmt.Registry) error {
