...
func (m *Permission) validateRelations(formats strfmt.Registry) error {
...
func (m *Permission) contextValidateRelations(ctx context.Context, formats strfmt.Registry) error {
