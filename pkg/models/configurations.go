...
func (m *Configurations) validateLink(formats strfmt.Registry) error {
...
func (m *Configurations) contextValidateLink(ctx context.Context, formats strfmt.Registry) error {
